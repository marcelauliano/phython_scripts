...
parser.add_argument('-r', type=int, choices=[1, 2, 3, 4], help='the type of regular expression to apply (1, 2, 3, 4). Look code comments to see regex', default=1)
parser.add_argument("-p", help= "-p: pattern to be at the beginning and end of path_matching. -r 3 or -r 4", default=1)
parser.add_argument("-e", help= "-b: pattern to be at the end of path_matching. -r 4", default=1)
...
terms=[]
m_names=('queryname','query_length','query_start','query_end','strand', 'path_matching','path_length','path_start','path_end', 'residue_matches', 'alignm_length', 'mapping_qual', 'other1', 'other2', '
other3', 'identity', 'other4')
...
#regex starts in p and ends in e
regex4 = r'^[><]{}.*{}$'.format(re.escape(str(args.p)), re.escape(str(args.e)))
